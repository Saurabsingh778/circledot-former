...
SOTA_AUROC   = 0.78
SOTA_SOURCE  = ("Sequence-based CNN models (Segal et al. Nature 2006; Kaplan et al. "
                "Nature 2009) on nucleosome positioning. "
                "Data source: Basu et al. Nature 2021 (Loop-seq), "
                "MOESM4 (nucleosomal library) vs MOESM6 (random library).")
